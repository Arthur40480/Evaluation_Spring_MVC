...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.formLogin();
        http.authorizeHttpRequests().antMatchers("/cityForm","/movieTheater","/confirmOrder","/customerForm","/movieForm","/movieTheatersForm","/recapOrder","/sessionForm").hasRole("ADMIN");
        http.authorizeHttpRequests().antMatchers("/confirmOrder","/customerForm","/recapOrder").hasRole("USER");
